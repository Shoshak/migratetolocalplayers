...
* [Перенос музыки](#перенос-музыки)
	* [spotify-dl](#1-spotify-dl)
	* [Ручная загрузка с ютуба и конвертация в mp3](#2-ручная-загрузка-с-ютуба-и-конвертация-в-mp3)
	* [Скачивание из ВК Музыки](#3-скачивание-из-вк-музыки)
	* [Скачивание из сторонних источников](#4-скачивание-из-сторонних-источников)
